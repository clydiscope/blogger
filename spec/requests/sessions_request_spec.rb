...
RSpec.describe SessionsController, type: :controller do
	...
	let(:my_user) { User.create!(name: "Fake Name", email: "fake_email@gmail.com", password: "fake_password") }
	...
	describe "POST sessions" do
		...
		it "flashes #new with bad email address" do
			post :create, params: {session: {email: "does not exist"}}
