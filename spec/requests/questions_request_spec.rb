...
RSpec.describe QuestionsController, type: :controller do
  ...
  let(:my_question) { Question.create!(title: RandomData.random_sentence, body: RandomData.random_question, resolved: false) }
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{post :create, params: {title: RandomData.random_sentence, body: RandomData.random_question}}.to change(Question,:count).by(1)
    end
  ...
  describe "GET edit" do
    ...
    it "assigns question for updating to @question" do
      get :edit, params: {id: my_question.id}
  ...
  describe "PUT update" do
    it "describes question with expected attributes" do
