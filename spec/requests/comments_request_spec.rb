...
RSpec.describe CommentsController, type: :controller do
	...
	let(:my_user) { User.create!(name: "Blogger User", email: "user@blogger.com", password: "helloworld") }
	let(:other_user) { User.create!( name: "Other Blogger User", email: RandomData.random_email, password: "helloworld", role: :member ) }
	...
	context "member user doing on a comment they don't own" do
		before do
	...
	context "member using doing CRUD on a post they own" do
		before do
