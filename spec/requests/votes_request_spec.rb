...
RSpec.describe VotesController, type: :controller do
	...
	let(:other_user) { User.create!(name: RandomData.random_name, email: RandomData.random_email, password: "hellworld") }
	...
	context "guest" do
		...
		describe "POST up_vote" do
			...
			it "the users first vote increases number post votes by one" do
