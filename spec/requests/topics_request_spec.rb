...
RSpec.describe TopicsController, type: :controller do
	...
	context "member user" do
		...
		before do
			user = User.create!(name: "Blogger User", email: "user@bloccit.com", password: "helloworld", role: :member)
			create_session(user)
		end
	...
	context "admin user" do
		before do
			user = User.create!(name: "Bloccit User", email: "user@blogger", password: "helloworld", role: :admin)
			create_session(user)
		end
